...
export const STATUTORY_DOCUMENTS: Record<string, PolicyDocument> = {
  'crpc-91': {
    ...
    admissibility:
      'Electronic notices transmitted via GUARDIAN automated dispatch carry cryptographic hash anchors compliant with Section 65B of the Indian Evidence Act 1872 and Section 63 of the Bharatiya Sakshya Adhiniyam 2023.',
    actionItems: [
  ...
  'npci-1930': {
    ...
    admissibility:
      'NPCI UTR transaction traces and clearing switch audit logs provided directly into GUARDIAN ledger.',
    actionItems: [
  ...
  'indiranagar-hq': {
    ...
    clauses: [
      ...
      },
      {
        ...
        text: 'Encrypted tactical mesh network operates on 154.250 MHz digital voice with GPS burst telemetry every 15 seconds. Direct integration with GUARDIAN Command HQ dashboard.',
  ...
  'security-encryption': {
    ...
    authority: 'GUARDIAN Information Security Directorate',
    ...
    clauses: [
      ...
      },
      {
        ...
        codeRef: 'GUARDIAN Security Matrix',
      },
    ],
    admissibility:
  ...
  'privacy-policy': {
    ...
    authority: 'Data Protection Board of India & GUARDIAN Governance Directorate',
